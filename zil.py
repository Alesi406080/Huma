#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To SHAHID-BAJWA
...
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mA.Creations\033[1;95m♡╭───•◈•───╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mSahil 
\033[1;94mBAJWA\033[1;91m: \033[1;91▒▓██████████████]99.9
\033[1;94mFacebook\033[1;91m: \033[1;91mhttps://www.facebook.com/03081008587sahil
\033[1;94mWhatsapp\033[1;91m: \033[1;91m+923081008587
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mA.CREATIONS\033[1;95m♡╰───•◈•───╯♡"""
jalan('    \033[1;96m............SAHIL.CREATIONS...............:')
jalan("\033[1;95m   ┈┈┈ABY CHUTIYAOO GHAR PY RHO    ☠️ ")
jalan('\033[1;92m   ┈┈┈BHAIR MAT NIKLO    ☠️ ')
jalan('\033[1;93m   ┈┈┈MUTH MAR K HATH B DHUO LIYE KRO  ☠️ ')
jalan("\033[1;96m   ┈┈┈CHAL APNY BAAP KO MAT SEKHA  ❤ ")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://youtu.be/sNGOmns1z1k')
    else:
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mA.creations\033[1;95m♡───•◈•───────♡"
	print "  \033[1;93m«---•◈•---Developed By Sahil-420---•◈•---»" #Dev:Black-Cat
	...
	print """
            ...
            ╚════════════════╝
♡──────────────•◈•──────────────♡.
: \033[1;96m .....Sahil A.creations............ \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp Num
               +923081008587"""
